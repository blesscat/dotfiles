...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/Users/blessma/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/Users/blessma/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/Users/blessma/.local/share/nvim/site/pack/packer/start/nvim-lspinstall",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/Users/blessma/.local/share/nvim/site/pack/packer/start/popup.nvim",
  ...
  ["vim-css-color"] = {
    loaded = true,
    path = "/Users/blessma/.local/share/nvim/site/pack/packer/start/vim-css-color",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/Users/blessma/.local/share/nvim/site/pack/packer/start/vim-surround",
